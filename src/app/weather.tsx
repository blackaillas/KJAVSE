...
const Weather = React.memo(function Weather() {
            ...
            <div className="flex flex-col items-center justify-center w-full text-gray-700 px-0 py-10 my-10 bg-gradient-to-br from-pink-200 via-purple-200 to-indigo-200 ">
                <div className="w-full max-w-screen-sm bg-white p-10 rounded-xl ring-8 ring-white ring-opacity-40">
                    <div className="flex justify-between">
                        ...
                        <svg className="fill-current text-yellow-400 hidden md:inline-block" xmlns="http://www.w3.org/2000/svg" height="96" viewBox="0 0 24 24" width="96">
